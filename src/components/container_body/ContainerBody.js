...
import {preevaluation_scenarios_enum, popUp_styles_enum} from "../constants/constans";
...
const ContainerBody = (props) => {
    ...
    const [selectVisibility, getselectVisibility] = useState(false)
        ...
        />
                ...
                <ErrorPopup style={popUp_styles_enum.error} status={errorStatus} txt={"creating request_date/ XML error"}/>
            </Fragment>
        );
    }
;
